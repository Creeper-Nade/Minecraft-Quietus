package com.quietus.server.resources;
...
/**
 * The ServerSkillTreeManager is responsible for reading data, which is called upon by com.quietus.event_listener.ResourceEvent
 */
